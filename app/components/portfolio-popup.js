...
export default function PortfolioCard({ content }) {
    ...
    return (
        <div id={content.id} className="rounded-2xl min-h-96 p-4 backdrop-blur-sm max-xl:flex-col flex gap-16 bg-white border-[1px] border-opacity-10 border-white bg-opacity-5 scroll-mt-24">
            ...
            <div className="flex-[5] relative flex justify-end group xl:hover:scale-125 xl:hover:translate-x-[-6rem] transition-transform duration-500 cursor-pointer">
